...
// Files
;(readFile, readFiles, updateFile, updateFiles, deleteFile, deleteFiles, uploadFiles)
...
// Collections
;(readCollection, readCollections, createCollection, updateCollection, deleteCollection)

// Fields
;(readField, readFields, readFieldsByCollection, createField, updateField, deleteField)
